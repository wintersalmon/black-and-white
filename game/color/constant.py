...
YELLOW = Color(CODE.YELLOW, (255, 255, 0))
ORANGE = Color(CODE.ORANGE, (255, 128, 0))
PURPLE = Color(CODE.PURPLE, (255, 0, 255))
CYAN = Color(CODE.CYAN, (0, 255, 255))

NAVYBLUE = Color(CODE.NAVYBLUE, (60, 60, 100))
